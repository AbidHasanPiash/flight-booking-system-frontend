...
export default function AdminOverview() {
    ...
    return (
        <div>
                ...
                <div className="bg-blue-100 p-4 rounded-lg shadow-lg flex items-center justify-between">
                    <div>
                        ...
                        {flightsLoading ? (
                            ...
                            <p className="text-2xl font-bold text-blue-900">{totalFlights?.length || 0}</p>
                        )}
                    </div>
                ...
                <div className="bg-green-100 p-4 rounded-lg shadow-lg flex items-center justify-between">
                    <div>
                        ...
                        {bookingsLoading ? (
                            ...
                            <p className="text-2xl font-bold text-green-900">{totalBookings?.length || 0}</p>
                        )}
                    </div>
            ...
            {/* Overview Section */}
            <div className="mt-20 bg-gray-50 p-2 rounded-lg">
